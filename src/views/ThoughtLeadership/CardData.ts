...
export const data = [
  ...
  },
  {
    ...
    text:
      "What will infrastructure be like Post COVID 19? Ravi shares his thoughts in this slide show",
    buttonText: "Learn More",
    href:
  ...
  },
  {
    ...
    text:
      "Ravi talks about the sustainable infrastructure opportunities in emerging markets.",
    buttonText: "Learn More",
    href:
  ...
  },
  {
    title: "SDG SUMMIT",
    text:
      "As a key panelist at the Economic Times Sustainable Development Goals Summit 2020, Ravi shares his views on overcoming the challenges being faced by global warming.",
    buttonText: "Listen Here",
  ...
  },
  {
    ...
    text:
      "A plethora of innovations are transforming the infrastructure sector. Newer methods of risk mitigation are needed in the next decade when technological obsolescence in the infrastructure will be high. Ravi explains…",
    buttonText: "Learn More",
    href:
