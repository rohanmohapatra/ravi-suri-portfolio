...
export const ImpactOnSociety: React.FC = () => {
  return (
    <>
      <Hidden xsDown>
        <ImpactOnSocietyDesktopView />
      </Hidden>
      <Hidden smUp>
        <ImpactOnSocietyMobileView />
      </Hidden>
    </>
  );
};

const ImpactOnSocietyDesktopView: React.FC = () => {
...
const ImpactOnSocietyMobileView: React.FC = () => {
  const classes = useStyles();
  return (
    <div className={classes.root}>
      <Heading heading="Impact On Society" />
      ...
      <Grid container className={[classes.padding, classes.two].join(" ")}>
        <Grid item xs={12}>
          {" "}
          <Heading heading="Business for Peace Foundation" />
        </Grid>

        <Grid item xs={12} className={classes.bpf}>
          <div
            className={classes.imageItem}
            style={{
              backgroundImage: `url(${pathName}/assets/peace/bpf.png)`,
      ...
      <Grid container className={[classes.padding, classes.two].join(" ")}>
        <Grid item xs={12}>
          <Heading heading="UNECE" />
        </Grid>

        <Grid item xs={12} className={classes.unece}>
          <div
            className={classes.imageItem}
            style={{
              backgroundImage: `url(${pathName}/assets/peace/unece.png)`,
      ...
      <Grid container className={[classes.padding, classes.two].join(" ")}>
        <Grid item xs={12}>
          <Heading heading="INTERNATIONAL SOCIETY OF PUBLIC PRIVATE PARTNERSHIP SCIENCES" />
        </Grid>
      ...
      <Grid container className={[classes.padding, classes.two].join(" ")}>
        <Grid item xs={12}>
          <Heading heading="CLIFFORD CAPITAL" />
        </Grid>
      ...
      <Grid container className={[classes.padding, classes.two].join(" ")}>
        <Grid item xs={12}>
          <Heading heading="BELT AND ROAD INITIATIVE" />
        </Grid>
        <Grid item xs={12} className={classes.bpf}>
          <div
            className={classes.imageItem}
